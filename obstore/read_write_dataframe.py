...
new_flytekit = "git+https://github.com/machichima/flytekit.git@c90a2ff747220c54cd3de554452eda3fe887fbce"
...
master_flytekit = "git+https://github.com/flyteorg/flytekit.git@master"
